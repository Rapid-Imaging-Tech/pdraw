...
#undef DO_
    ...
    void Tile_Feature::Clear() {
        ...
        geometry_.Clear();
        if (has_raster()) {
            GOOGLE_DCHECK(!raster_.IsDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited()));
            (*raster_.UnsafeRawStringPointer())->clear();
        }
...
#if LANG_CXX11
    void Tile_Feature::set_raster(::std::string&& value) {
        set_has_raster();
        raster_.SetNoArena(
                           &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
        // @@protoc_insertion_point(field_set_rvalue:vector_tile.Tile.Feature.raster)
    }
#endif
